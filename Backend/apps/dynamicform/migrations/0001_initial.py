...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(blank=True, help_text='Some descriptive title (other questions). Max 25 characters. Blank and Null are allowed.', max_length=25, null=True)),
                ('created', models.DateTimeField(default=django.utils.timezone.now, help_text='Fecha de creación del usuario', verbose_name='Fecha de cración')),
                ('updated', models.DateTimeField(auto_now=True, help_text='Fecha de edición del usuario', verbose_name='Fecha de edición')),
                ('order', models.PositiveIntegerField(default=0, help_text='Orden de visualización', verbose_name='Orden')),
            ],
            options={
                'verbose_name': 'TV Other Questions',
                'verbose_name_plural': 'TV Other Questions',
                'db_table': 'apps_tv_other_questions',
                'ordering': ['order', 'id'],
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('otherQuestions', models.ManyToManyField(blank=True, help_text='TV other questions. Required.', to='dynamicform.tvotherquestionsmodel')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='questions',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dynamicform.tvquestionsmodel'),
        ),
    ]
